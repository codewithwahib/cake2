    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="contact-form p-8 bg-white shadow-lg rounded-lg max-w-lg w-full mx-auto mt-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <button type="submit" className="w-full bg-purple-800 text-white py-2 rounded-md hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600">
              Send Message
            </button>
          </div>
        </form>
